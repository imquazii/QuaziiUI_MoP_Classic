...
DF.CooldownsInfo = {
	...
	[204018] = {
		...
		class = "PALADIN",
		type = 3,
	}, --Blessing of Spellwarding (talent)
	[231895] = {
		cooldown = 120,
		duration = 25,
		talent = 22215,
	...
	[207399] = {
		...
		class = "SHAMAN",
		type = 4,
	}, --Ancestral Protection Totem (talent)
	[16191] = {
		cooldown = 180,
		duration = 8,
		talent = false,
	...
	[102560] = {
		...
		class = "DRUID",
		type = 1,
	}, --Incarnation: Chosen of Elune (talent)
	[22812] = {
		cooldown = 60,
		duration = 12,
		talent = false,
	...
	[102543] = {
		...
		class = "DRUID",
		type = 1,
	}, --Incarnation: King of the Jungle (talent)
	[61336] = {
		cooldown = 120,
		duration = 6,
		talent = false,
		...
		class = "DRUID",
		type = 2,
	}, --Survival Instincts (2min feral 4min guardian, same spellid)
	[77764] = {
		cooldown = 120,
		duration = 8,
		talent = false,
	...
	[102558] = {
		...
		class = "DRUID",
		type = 2,
	}, --Incarnation: Guardian of Ursoc (talent)
	[33891] = {
		cooldown = 180,
		duration = 30,
		talent = 22421,
...
function DF:GetSpellsForEncounterFromJournal(instanceEJID, encounterEJID)
	...
	local name, description, encounterID, rootSectionID, link =
		DetailsFramework.EncounterJournal.EJ_GetEncounterInfo(encounterEJID) --taloc (primeiro boss de Uldir)
	if not name then
