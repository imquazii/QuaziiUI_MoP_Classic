...
function AceTimer:ScheduleTimer(func, delay, ...)
	...
	if type(func) == "string" then
		...
		elseif not self[func] then
			error(
				MAJOR .. ": ScheduleTimer(callback, delay, args...): Tried to register '" .. func .. "' as the callback, but it doesn't exist in the module.",
				2
			)
		end
	end
...
function AceTimer:ScheduleRepeatingTimer(func, delay, ...)
	...
	if type(func) == "string" then
		...
		elseif not self[func] then
			error(
				MAJOR .. ": ScheduleRepeatingTimer(callback, delay, args...): Tried to register '" .. func .. "' as the callback, but it doesn't exist in the module.",
				2
			)
		end
	end
